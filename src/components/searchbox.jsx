...
const SearchBox = () => {
  ...
  const handleInputFocus = () => {
    setInputWidth("w-full md:w-[140px] lg:w-[250px] xl:w-[400px] border-none"); // Responsive width on focus
  };
  ...
  return (
    <div className="relative">
      <div className="hidden md:flex font-IranYekan font-normal text-sm relative w-full max-w-lg  items-center border border-accent bg-white/0 justify-between rounded-xl overflow-hidden mt-1 px-3"> {/* Styling for the search box */}
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height={15} fill="#4E9984"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
        <input
          type="text"
          value={searchInput}
        ...
        <ul ref={suggestionsRef} className="font-IranYekan font-normal text-sm absolute z-10 bg-background border rounded-2xl shadow-lg mt-1 w-full max-w-lg">
          {suggestions.map((suggestion) => (
            <li key={suggestion.id} className="p-2 hover:bg-accent/10 cursor-pointer">
              <Link to={suggestion.link} className="flex items-center space-x-2 rtl:space-x-reverse">
