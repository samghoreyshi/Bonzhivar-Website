...
export default function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-8 right-8 z-50 bg-accent hover:bg-accent/90 text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 transition-all duration-300 hover:scale-105"
