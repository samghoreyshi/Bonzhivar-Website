  ...
  return (
    <>
      <div className="w-full h-[100px] cursor-pointer flex justify-between items-center rounded-lg relative overflow-hidden group p-5">
        ...
        <div className="font-IranYekan font-normal text-sm border border-accentLight hover:border-accentLight hover:text-gray-600 rounded-lg my-5 p-2 transition-all duration-300 relative z-10 rotate-180 hover:scale-110">
          <svg
        ...
        <h2 className="font-IranYekan font-bold text-white text-base sm:text-2xl text-right direction-rtl relative z-10">
